...
The schema will need to be adjusted to support all of the events available <a href="http://www.voip-info.org/wiki/view/asterisk+manager+events">here</a>. Given the schema-less nature of <a href="http://couchdb.apache.org/">CouchDB</a> all events are supported.
